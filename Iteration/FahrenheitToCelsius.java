...
public class FahrenheitToCelsius{
    ...
    while (fahrenheit >= MAX_PARK_TEMP){
        System.out.printf("Error: Temperature value cannot be more than %d.\n", MAX_TEMP);
        System.out.println("Please enter another temperature value.");
